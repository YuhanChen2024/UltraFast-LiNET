...
class Shift_Block_split(nn.Module):
    ...
    def forward(self, x):
        ...
        # 移位-----------------------------------------------------------------------------------------------------------
        # print(out1, 'zeros_like ------------------------------------------------------ zeros_like')
...
if __name__ == "__main__":
    model = Shift_Block_split(Dia=1)
    input = torch.ones(1, 3, 400, 600)
    # print(input, 'origan ------------------------------------------------------- origan')
